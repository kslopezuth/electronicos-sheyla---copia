package com.hn.electronicossheyla.views.productos;

import com.hn.electronicossheyla.data.SampleBook;
import com.hn.electronicossheyla.services.SampleBookService;
...
@PageTitle("Productos")
@Route(value = "master-detail2/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
public class ProductosView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "master-detail2/%s/edit";
    ...
    public ProductosView(SampleBookService sampleBookService) {
